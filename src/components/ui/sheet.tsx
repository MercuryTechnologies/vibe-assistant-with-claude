...
function SheetOverlay({
  ...
  return (
    <SheetPrimitive.Overlay
      ...
      className={cn("ds-sheet-overlay", className)}
      {...props}
    />
  )
}
...
function SheetTitle({
  ...
  return (
    <SheetPrimitive.Title
      ...
      className={cn("ds-sheet-title text-title-secondary", className)}
      {...props}
    />
  )
}
...
function SheetDescription({
  ...
  return (
    <SheetPrimitive.Description
      ...
      className={cn("ds-sheet-description text-body-sm", className)}
      {...props}
    />
  )
}
